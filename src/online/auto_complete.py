...
def completions_with_delete(best_k_completions, substring, amount) -> List:
    res = []
...
def completions_with_replace(best_k_completions, substring, amount) -> List:
...
def completions_with_add(best_k_completions, substring, amount) -> List:
    res = []
    len_substring = len(substring)
    complete_list = init_complete_list(best_k_completions)
...
def get_completions_without_change(substring) -> List:
    best_k_completions = []
...
def get_completions_with_change(best_k_completions, substring, amount) -> List:
    res = completions_with_delete(best_k_completions, substring, amount)
